...
class TestAlgorithms(unittest.TestCase):
    ...
    def test_default_decimation(self):
        ...
        cascade_tree.generate(
            [test_wav(scale=1), test_wav(scale=2), test_wav(scale=3), test_wav(scale=4)],
            lambda x, y, z: x,
        )
        ...
        # Then convolve again, j2 - j1 is 1 so add a stride of 2, decimate wav by 2
        # to adjust bandwidth to decimated signal
        # Then convolve again  j3 - j2 is 1 so add a stride of 2, decimate wave by 4,
        ...
        # to adjust bandwidth to decimated signal
        # Then convolve again  j3 - j2 is 1 so add a stride of 2, decimate wave by 2,
